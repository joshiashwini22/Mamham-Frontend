        ...
        >
          {isSidebarOpen ? (
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M5.75 4a.75.75 0 00-.75.75v10.5c0 .414.336.75.75.75h8.5a.75.75 0 000-1.5h-8.5a.75.75 0 01-.75-.75V4.75c0-.414.336-.75.75-.75h8.5a.75.75 0 010 1.5h-8.5z"
            />
          ) : (
            <path
              fillRule="evenodd"
              clipRule="evenodd"
              d="M2 4.75A.75.75 0 012.75 4h14.5a.75.75 0 110 1.5H2.75A.75.75 0 012 4.75zm0 5a.75.75 0 01.75-.75h14.5a.75.75 0 110 1.5H2.75A.75.75 0 012 9.75zm0 5a.75.75 0 01.75-.75h14.5a.75.75 0 110 1.5H2.75A.75.75 0 012 14.75z"
            />
          )}
        </svg>
      </button>

      {isSidebarOpen && ( // Render close button only if sidebar is open
        <button
          onClick={closeSidebar} // Call closeSidebar function on button click
          className="fixed inset-0 z-50 w-full h-full cursor-default focus:outline-none"
        ></button>
      )}
